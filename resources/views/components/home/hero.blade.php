<div class="relative w-full h-screen">
    ...
    <div class="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style="background-image: url('https://images.unsplash.com/photo-1544025162-d76690b67f11?q=80&w=2000&auto=format&fit=crop');">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        <h1
            class="font-serif text-5xl md:text-8xl font-bold uppercase tracking-[0.15em] text-primary drop-shadow-2xl mb-6">
            Monte Carmelo
        </h1>
