...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400&family=Playfair+Display:wght@400;600;700&display=swap"
        rel="stylesheet">
...
<body class="min-h-screen font-sans antialiased bg-background-main text-text-main flex flex-col">
    ...
    <div class="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div
            class="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-[#D4AF37] rounded-full mix-blend-soft-light filter blur-[100px] opacity-20 animate-pulse-slow">
        </div>
        <div
            class="absolute bottom-[-10%] right-[-10%] w-[35vw] h-[35vw] bg-[#8C1C13] rounded-full mix-blend-soft-light filter blur-[120px] opacity-20">
        </div>
        <div
            class="absolute top-[40%] left-[50%] transform -translate-x-1/2 w-[50vw] h-[50vw] bg-[#1E1E1E] rounded-full mix-blend-overlay filter blur-[150px] opacity-40">
        </div>
        ...
        <div class="drawer-side z-50">
            ...
            <div class="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
                ...
                <ul>
                    ...
                    <li><a href="/products" class="text-lg"><x-mary-icon name="o-shopping-bag" class="w-5 h-5" />
                            Productos</a></li>
                    <li><a href="#" class="text-lg"><x-mary-icon name="o-users" class="w-5 h-5" /> Nosotros</a></li>
                    <li><a href="/contact" class="text-lg"><x-mary-icon name="o-map-pin" class="w-5 h-5" /> Contacto</a>
                    </li>
                </ul>
            </div>
        </div>
