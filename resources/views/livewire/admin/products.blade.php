...
<div>
        ...
        >
            ...
            @scope('is_active', $product)
                <x-mary-toggle 
                    ...
                    wire:model="products.{{ $loop->index }}.is_active" 
                    class="toggle-success toggle-sm" 
            ...
            @scope('actions', $product)
                <div class="flex">
                    <x-mary-button icon="o-pencil" wire:click="edit({{ $product->id }})" class="btn-ghost btn-sm text-info" />
                    <x-mary-button icon="o-trash" wire:click="delete({{ $product->id }})" class="btn-ghost btn-sm text-error" onclick="return confirm('¿Seguro?') || event.stopImmediatePropagation()" />
                </div>
            @endscope
        </x-mary-table>
    </x-mary-card>
    ...
    {{-- DRAWER FORM --}}
    <x-mary-drawer wire:model="drawer" title="{{ $editingId ? 'Editar Producto' : 'Nuevo Producto' }}" right class="w-11/12 lg:w-1/2">
        <x-mary-form wire:submit="save">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                ...
                <x-mary-select 
                    ...
                    :options="[['id' => 'kg', 'name' => 'Kilogramo (kg)'], ['id' => 'unit', 'name' => 'Unidad (u)'], ['id' => 'pack', 'name' => 'Pack']]" 
